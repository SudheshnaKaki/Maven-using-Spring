...
public class WalletTransaction {
	...
	@Transient
	private AccountBean beneficiaryAccID; // in case of transfer
	...
	public AccountBean getBeneficiaryAccID() {
		return beneficiaryAccID;
	}
	public void setBeneficiaryAccountBean(AccountBean beneficiaryAccID) {
	...
	public String toString() {
		return "WalletTransaction [transactionId=" + transactionId
				...
				+ transactionType + ", beneficiaryAccID="
				+ beneficiaryAccID + ", transactionDate="
				+ transactionDate + "]";
	}
	@Override
	public int hashCode() {
